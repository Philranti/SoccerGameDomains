package za.ac.cput.projects.domains.SoccerLeagues;

import java.util.Objects;

public class Divisions {
    private int divisionPlayed;
    ...
    public static class Builder{
        ...
        public Builder divisionPlayed(int divisionPlayed) {
